...
public class StopListener extends ListenerAdapter
{
	public void onGuildMessageReceived(GuildMessageReceivedEvent e)
	{
		 ...
		 if(isStaff(e.getMember()))
		 {
			  ...
			  if(args[0].equalsIgnoreCase(Main.PREFIX + "disable") && args[1].equalsIgnoreCase("emoteselfroles"))
			  {
				   try
				   {
				   	Data.writeEmoteRoleData();;
				   ...
				   e.getChannel().sendMessage("*Disabling al's emote self-role code...*").complete();
				   e.getJDA().shutdown();
				   System.exit(0);
			  } 
		 } 
